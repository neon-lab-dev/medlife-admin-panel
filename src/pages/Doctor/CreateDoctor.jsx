...
import { createDoctor } from '../../api/product'
...
const CreateProduct = () => {
    ...
    const { mutate, isPending, isSuccess } = useMutation({
        ...
        onSuccess: () => {
            Swal.fire({
                title: "Doctor Add Success",
                text: `${doctorName} added to your store `,
                icon: "success",
            })
    ...
    const { specialization1, doctorName, education, experience, location,
        specialization3, diseaseHandle, specialization2, } = watch()
        ...
        <div className='bg-lightgray h-full w-full p-6 py-8'>
            <div className="bg-white overflow-x-auto rounded-[16px] p-4  ps-10 ">
                ...
                <div className="flex items-center  justify-between">
                    ...
                    <h1 className="text-[32px] text-black font-bold flex-1 me-6 text-center">Add Doctor</h1>
                </div>
                ...
                <div className="flex  gap-3 my-5 mt-10 flex-wrap md:flex-nowrap  w-full">
                        ...
                        <form onSubmit={handleSubmit(handleFormSubmit)} className='max-w-[513px] md:min-w-[460px] min-w-[300px]'>
                            ...
                            <div className="my-5">
                                <input
                                    {...register("experience", {
                                        required: { value: true, message: "This field is required" },
                                        min: { value: 0, message: "Minimum 0 year Experience is required" }
                                    })}
                                    className={`w-full h-[45px] rounded-xl border-darkstone outline-none border ps-3 text-[16px] text-gray2 ${errors.experience && "border-red"}`} type="number" placeholder="Enter Doctor Experience" />
                                {errors.experience && <span className='text-red ms-2'>{errors.experience.message}</span>}
                            </div>
                            ...
                            <div className="my-5">
                                <textarea
                                    ...
                                    className={`w-full resize-none pt-3 h-[112px] rounded-xl border-darkstone outline-none border ${errors.education && "border-red"} ps-3 text-[16px] text-gray2 `} type="text" placeholder="Enter Doctor Education" />
                                {errors.education && <span className='text-red ms-2'>{errors.education.message}</span>}
                            </div>
                            ...
                            <div className="my-5">
                                <textarea
                                    {...register("location", {
                                        required: { value: true, message: "This field is required" },
                                        minLength: { value: 3, message: "Minimun length is 8 character " },
                                    })}
                                    className={`w-full resize-none pt-3 h-[112px] rounded-xl border-darkstone outline-none border ${errors.location && "border-red"} ps-3 text-[16px] text-gray2 `} type="text" placeholder="Enter Doctor Location" />
                                {errors.location && <span className='text-red ms-2'>{errors.location.message}</span>}
                            </div>
                            ...
                            <div className="my-5 w-full ">
                                <div
                                    ...
                                    >
                                        <option value="" selected disabled>DiseaseHandle</option>
                                        {
                                            diseaseHandleOptions.map(item => <option key={item} value={item}>{item}</option>)}
                                    </select>
                                </div>
                                {errors.sub_category && (
                            ...
                            <div className="my-5">
                                <input
                                    ...
                                    className={`w-full h-[45px] rounded-xl border-darkstone outline-none border ps-3 text-[16px] text-gray2 ${errors.specialization1 && "border-red"}`} type="text" placeholder="Enter Doctor Specification 1" />
                                {errors.specialization1 && <span className='text-red ms-2'>{errors.specialization1.message}</span>}
                            </div>
                            <div className="my-5">
                                <input
                    ...
                    <div className="border-dashed border-l-2  ps-5 pe-3 flex flex-col  items-center  border-l-stone1">
                        ...
                        <div className="h-[420px] md:min-w-[400px] min-w-[300px] rounded-xl mt-7 p-4  text-center flex flex-col justify-center items-center max-w-[453px] border border-stone2">
                            {
                                selectedImages ? <img src={URL.createObjectURL(selectedImages)} className='h-full w-full object-contain object-center ' alt="" />
                                    : <>
                                        <input
                                            type="file"
                                            onChange={handleImageChange}
                                            ref={inputRef}
                                            className='hidden' doctorName="" id="" />
                        ...
                        {selectedImages &&
                            <div className="text-center mt">
                                <button onClick={e => setSelectedImages(null)} type="button" className="mt-2 text-md text-red">Remove Image</button>
                            </div>
                        }
        ...
        <dialog id="verificationModal" className="modal " >
            <form method="dialog" className="modal-box  max-h-[777px] w-[656px]">
                ...
                <div className="mt-5 font-semibold px-2">
                    ...
                    <div className='my-[15px] flex items-center gap-2 flex-wrap lg:text-[16px] max-xl:text-[18px]'>Doctor Name:
                        {doctorName ? <span className='text-base font-semibold'>{doctorName}</span> : <span className='text-red text-base'>Please enter Doctor Name!</span>}
                    </div>

                    <div className='my-[15px] flex items-center gap-2 flex-wrap lg:text-[16px] max-xl:text-[18px]'>Education:
                        {education ? <span className='text-base font-semibold'>{education}</span> : <span className='text-red text-base'>Please enter Education!</span>}
                    </div>

                    <div className='my-[15px] flex items-center gap-2 flex-wrap lg:text-[16px] max-xl:text-[18px]'>Experience:
                        {experience ? <span className='text-base font-semibold'>{experience}</span> : <span className='text-red text-base'>Please enter experience!</span>}
                    </div>

                    <div className='my-[15px] flex items-center gap-2 flex-wrap lg:text-[16px] max-xl:text-[18px]'>Location:
                        {location ? <span className='text-base font-semibold'>{location}</span> : <span className='text-red text-base'>Please enter Location!</span>}
                    </div>

                    <div className='my-[15px] flex items-center gap-2 flex-wrap lg:text-[16px] max-xl:text-[18px]'>DiseaseHandle:
                        {diseaseHandle ? <span className='text-base font-semibold'>{diseaseHandle}</span> : <span className='text-red text-base'>Please enter DiseaseHandle!</span>}
                    </div>

                    <div className='my-[15px] flex items-center gap-2 flex-wrap lg:text-[16px] max-xl:text-[18px]'>Specialization1:
