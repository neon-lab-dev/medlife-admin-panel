                            ...
                            >
                                ...
                                <div className="">
                                    <input
                                        ...
                                        className={` h-[45px] w-full rounded-xl border-darkstone outline-none border ps-3 text-[16px] text-gray2 ${errors.doctorName && "border-red"
                                            }`}
                                        type="text"
                                ...
                                <div className="my-5">
                                    <input
                                        ...
                                        className={`w-full h-[45px] rounded-xl border-darkstone outline-none border ps-3 text-[16px] text-gray2 ${errors.experience && "border-red"
                                            }`}
                                        type="number"
                                ...
                                <div className="my-5">
                                    <textarea
                                        ...
                                        className={`w-full resize-none pt-3 h-[112px] rounded-xl border-darkstone outline-none border ${errors.education && "border-red"
                                ...
                                <div className="my-5">
                                    <textarea
                                        ...
                                        className={`w-full resize-none pt-3 h-[112px] rounded-xl border-darkstone outline-none border ${errors.location && "border-red"
                                            } ps-3 text-[16px] text-gray2 `}
                                        type="text"
                                ...
                                <div className="my-5">
                                    <input
                                        ...
                                        className={`w-full h-[45px] rounded-xl border-darkstone outline-none border ps-3 text-[16px] text-gray2 ${errors.specialization1 && "border-red"
                                            }`}
                                        type="text"
                                ...
                                <div className="my-5">
                                    <input
                                        ...
                                        className={`w-full h-[45px] rounded-xl border-darkstone outline-none border ps-3 text-[16px] text-gray2 ${errors.specialization2 && "border-red"
                                            }`}
                                        type="text"
                                ...
                                <div className="my-5">
                                    <input
                                        ...
                                        className={`w-full h-[45px] rounded-xl border-darkstone outline-none border ps-3 text-[16px] text-gray2 ${errors.specialization3 && "border-red"
                                            }`}
                                        type="text"
